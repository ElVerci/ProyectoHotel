...
public class Suite extends Habitacion implements Reservable, Serializable {

    public Suite(int identificador, double precioDia) {
   ...
   @Override
    ...
    public String toString() {
        return "Número: " + identificador +" Tipo: Suite" + " Precio Habitual: " + precioDia;
    }
}

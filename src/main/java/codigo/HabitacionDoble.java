...
public class HabitacionDoble extends Habitacion implements Reservable, Serializable {

    public HabitacionDoble(int identificador, double precioDia) {
    ...
    public String toString() {
        return "Número: " + identificador +" Tipo: Habitacion Doble" + " Precio Habitual: " + precioDia;
    }
